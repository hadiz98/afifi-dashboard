  ...
  return (
    ...
    >
      {!isLink ? null : isLinkEditMode ? (
        <div className="flex items-center space-x-2 rtl:space-x-reverse rounded-md border p-1 ps-2">
          <Input
            ref={inputRef}
            value={editedLinkUrl}
        ...
        <div className="flex items-center justify-between rounded-md border p-1 ps-2">
          <a
